...
// system understands that this "array" is an array of integers,
// and the length of the array is available to it.

// Using sizeof(arr), in the function display() is interpreted differently.
...
// There is no information available solely from the pointer about
// the length of the array.  Therefore, we must pass in the length
// of the array to the function.  Although "array" and "arr" look the same,
